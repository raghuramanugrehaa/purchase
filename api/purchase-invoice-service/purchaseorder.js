...
router.get('/:companyId/order/', function(req, res) {
    ...
    var requrl=config.get('myob.host') +"/AccountRight/"+companyId+"/Purchase/Order/Service?format=json";
...
router.get('/:companyId/order/:id', function(req, res) {
    var companyId = req.params.companyId;
    var id = req.params.id;
    var requrl=config.get('myob.host') +"/AccountRight/"+companyId+"/Purchase/Order/Service/"+id+"?format=json"
...
// Create a Invoice
router.post('/:companyId/order',function(req, res) {
    var companyId = req.params.companyId;
...
router.put('/:companyId/order/:id', function(req, res) {
    var id = req.params.id;
    var companyId = req.params.companyId;
    var requrl=config.get('myob.host') +"/AccountRight/"+companyId+"/Purchase/Order/Service/"+id+"/?format=json";
    var requestBody = JSON.stringify(req.body);
...
router.delete('/:companyId/order/:id', function(req, res) {
    var id = req.params.id;
    var companyId = req.params.companyId;
    var requrl=config.get('myob.host') +"/AccountRight/"+companyId+"/Purchase/Order/Service/"+id+"/?format=json"
